...
public class VerificarNumeroTurmaValidator implements Validator {
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		...
		else if(numero != null && verificarNumeroConsulta(numero)) {
			
			descricaoErro = label + ": Não é possível cadastrar este número, pois já está cadastrado !";
			descricaoCampo = "Por favor informe o número novamente !";
			FacesMessage facesMessage = new FacesMessage();
			validarMsgErro(descricaoErro, descricaoCampo, facesMessage);
	...
	private boolean verificarNumeroConsulta(String numero) {
		List<Turma> turmas = turmaService.getVerificarNumero(numero);
